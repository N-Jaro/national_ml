...
from train_dem_alphaearth_lightning import MDMT_DEM_AlphaEarth_LitModule
...
def main():
    ...
    # --- W&B flags ---
    parser.add_argument("--wandb_project", type=str, default="mdmt-hydro-dem-alphaearth")
    ...
    # Model
    lit = MDMT_DEM_AlphaEarth_LitModule(
        lr=args.lr,
    ...
    ckpt = ModelCheckpoint(
        ...
        filename="mdmt-dem-alphaearth-{epoch:02d}-{val_loss:.4f}",
        monitor="val_loss",
        mode="min",
        save_top_k=3
    )
