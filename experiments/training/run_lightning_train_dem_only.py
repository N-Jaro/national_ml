...
from train_dem_only_lightning import MDMT_DEM_Only_LitModule
from data_module_dem_only import PatchDataModule_DEM_Only
...
def main():
    ...
    # --- W&B flags ---
    parser.add_argument("--wandb_project", type=str, default="mdmt-hydro-dem-only")
    ...
    ckpt = ModelCheckpoint(
        ...
        filename="mdmt-dem-only-{epoch:02d}-{val_loss:.4f}",
        monitor="val_loss",
        mode="min",
        save_top_k=3
    )
