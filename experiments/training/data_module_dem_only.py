# data_module_dem_only.py
import torch
import numpy as np
import pytorch_lightning as pl
from torch.utils.data import DataLoader, random_split

from data.patchDataLoader_dem_only import MultimodalPatchDataset_DEM_Only

VALID_D8_CODES = [1, 2, 4, 8, 16, 32, 64, 128]

class PatchDataModule_DEM_Only(pl.LightningDataModule):
    def __init__(
        self,
        base_path,
    ...
    def setup(self, stage=None):
        if self.use_explicit_split:
            ...
            full = MultimodalPatchDataset_DEM_Only(
                base_path=self.base_path,
