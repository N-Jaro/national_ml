# data_module_alphaearth_only.py 
import torch
import numpy as np
...
class PatchDataModule_AlphaEarth_Only(pl.LightningDataModule):
    def __init__(
        self,
        base_path,
    ...
    def setup(self, stage=None):
        if self.use_explicit_split:
            ...
            self.train_ds = MultimodalPatchDataset_AlphaEarth_Only(
            ...
            self.val_ds = MultimodalPatchDataset_AlphaEarth_Only(
                base_path=self.base_path,
            ...
            full = MultimodalPatchDataset_AlphaEarth_Only(
                base_path=self.base_path,
