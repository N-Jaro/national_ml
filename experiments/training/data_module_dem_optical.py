...
class PatchDataModule_DEM_Optical(pl.LightningDataModule):
    def __init__(
        self,
        base_path,
    ...
    def setup(self, stage=None):
        if self.use_explicit_split:
            ...
            self.train_ds = MultimodalPatchDataset_DEM_Optical(
            ...
            self.val_ds = MultimodalPatchDataset_DEM_Optical(
                base_path=self.base_path,
            ...
            full = MultimodalPatchDataset_DEM_Optical(
                base_path=self.base_path,
