...
#-----------------------------------------------------------------------------
# Slurm job directives for DEM + AlphaEarth model training (single job).
#-----------------------------------------------------------------------------

# Set the name of the job
#SBATCH --job-name=mdmt-dem-alphaearth-single
...
# Set the memory for the job (increased for DEM + 64-channel AlphaEarth inputs)
#SBATCH --mem=120G
...
#SBATCH --output=slurm_logs/mdmt-dem-alphaearth-single_%j.out
#SBATCH --error=slurm_logs/mdmt-dem-alphaearth-single_%j.err
...
WANDB_NAME="dem_alphaearth_${DATE_TIME}_run1"

# Create the log directory if it doesn't exist
mkdir -p slurm_logs

echo "======================================================"
echo "Starting single DEM + AlphaEarth Training job"
...
echo "======================================================"
echo "Finished DEM + AlphaEarth training job."
echo "======================================================"