#!/bin/bash
#SBATCH --job-name=train_all_modalities_alphaearth_single
...
#SBATCH --output=/u/nathanj/national_ml/experiments/training/slurm_logs_all_modalities_alphaearth/slurm_%j.out
#SBATCH --error=/u/nathanj/national_ml/experiments/training/slurm_logs_all_modalities_alphaearth/slurm_%j.err
...
# Modern HUC-level train/val split configuration for single run testing
# Using optimal HUC configuration for geographic generalization
