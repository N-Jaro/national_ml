...
#-----------------------------------------------------------------------------
# Slurm job directives for DEM + SAR model training.
# Run the entire training process as a single, large job.
#-----------------------------------------------------------------------------

# Set the name of the job
#SBATCH --job-name=mdmt-dem-sar-train
...
#SBATCH --output=slurm_logs/mdmt-dem-sar-train_%j.out
#SBATCH --error=slurm_logs/mdmt-dem-sar-train_%j.err
...
WANDB_NAME="dem_sar_${DATE_TIME}_run${SLURM_ARRAY_TASK_ID}"

# Create the log directory if it doesn't exist
mkdir -p slurm_logs

echo "======================================================"
echo "Starting Slurm job array task for DEM + SAR Training"
