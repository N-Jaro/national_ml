...
#-----------------------------------------------------------------------------
# Slurm job directives for DEM + Optical model training.
# Run the entire training process as a single, large job.
#-----------------------------------------------------------------------------

# Set the name of the job
#SBATCH --job-name=mdmt-dem-optical-train
...
#SBATCH --output=slurm_logs/mdmt-dem-optical-train_%j.out
#SBATCH --error=slurm_logs/mdmt-dem-optical-train_%j.err
...
WANDB_NAME="dem_optical_${DATE_TIME}_run${SLURM_ARRAY_TASK_ID}"

# Create the log directory if it doesn't exist
mkdir -p slurm_logs

echo "======================================================"
echo "Starting Slurm job array task for DEM + Optical Training"
