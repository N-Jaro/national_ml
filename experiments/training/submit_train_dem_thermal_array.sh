...
#SBATCH --job-name=train_dem_thermal_array
...
WANDB_NAME="dem_thermal_${DATE_TIME}_run${SLURM_ARRAY_TASK_ID}"

# Create the log directory if it doesn't exist
mkdir -p slurm_logs

echo "======================================================"
echo "Starting Slurm job array task for DEM + Thermal Training"
...
echo "======================================================"
echo "Finished DEM + Thermal training job."
echo "======================================================"