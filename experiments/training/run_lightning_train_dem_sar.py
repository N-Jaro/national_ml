...
from train_dem_sar_lightning import MDMT_DEM_SAR_LitModule
from data_module_dem_sar import PatchDataModule_DEM_SAR
...
def main():
    ...
    # --- W&B flags ---
    parser.add_argument("--wandb_project", type=str, default="mdmt-hydro-dem-sar")
    ...
    ckpt = ModelCheckpoint(
        ...
        filename="mdmt-dem-sar-{epoch:02d}-{val_loss:.4f}",
        monitor="val_loss",
        mode="min",
        save_top_k=3
    )
