...
from train_dem_optical_lightning import MDMT_DEM_Optical_LitModule
from data_module_dem_optical import PatchDataModule_DEM_Optical
...
def main():
    ...
    parser.add_argument("--optical_channels", type=int, default=6, help="Number of optical channels")
    ...
    # --- W&B flags ---
    parser.add_argument("--wandb_project", type=str, default="mdmt-hydro-dem-optical")
    ...
    dm = PatchDataModule_DEM_Optical(
    ...
    # Model
    lit = MDMT_DEM_Optical_LitModule(
        lr=args.lr,
    ...
    ckpt = ModelCheckpoint(
        ...
        filename="mdmt-dem-optical-{epoch:02d}-{val_loss:.4f}",
        monitor="val_loss",
        mode="min",
        save_top_k=3
    )
