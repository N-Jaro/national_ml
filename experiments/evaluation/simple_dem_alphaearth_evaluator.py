#!/usr/bin/env python3
"""
Simple DEM + AlphaEarth Model Evaluator
...
def main():
    parser = argparse.ArgumentParser(description="Simple DEM + AlphaEarth Model Evaluator")
    ...
    parser.add_argument("--output-dir", type=str,
                       default="/u/nathanj/national_ml/experiments/evaluation/simple_dem_alphaearth_results",
    ...
    csv_path = output_dir / f"simple_dem_alphaearth_evaluation_{timestamp}.csv"
    results_df.to_csv(csv_path, index=False)
    
    # Save JSON
    json_path = output_dir / f"simple_dem_alphaearth_evaluation_{timestamp}.json"
    results_df.to_json(json_path, orient='records', indent=2)
    
    # Print summary
    print("\n" + "="*80)
    print("DEM + ALPHAEARTH EVALUATION COMPLETED")
    print("="*80)
