...
#SBATCH --job-name=dem_sanity_dev

# Specify the output and error files for each job
#SBATCH --output=/u/nathanj/national_ml/experiments/evaluation/analysis/dem_sanity/slurm_logs/dem_sanity_dev_%j.out
#SBATCH --error=/u/nathanj/national_ml/experiments/evaluation/analysis/dem_sanity/slurm_logs/dem_sanity_dev_%j.err

# DEM Sanity Analysis - Development Version (Minimal 3 HUCs)
# Runtime: ~10-15 minutes
# Purpose: Quick testing, debugging, proof-of-concept
...
echo "Starting DEM Sanity Analysis (Development - Minimal HUCs)..."
...
# Run the analysis with minimal HUCs
...
echo "DEM Sanity Analysis (Development) completed at $(date)"