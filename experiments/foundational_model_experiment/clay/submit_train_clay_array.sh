...
#-----------------------------------------------------------------------------
# Slurm job array for Clay foundation model training with 9-channel input.
# Adapts pre-trained Clay weights to 9-channel multi-modal data.
#-----------------------------------------------------------------------------

# Set the name of the job
#SBATCH --job-name=clay-9ch-array
...
# Set the memory for each job (optimized for 9-channel Clay + foundation model)
#SBATCH --mem=128G
...
#SBATCH --output=slurm_logs/clay-9ch-array_%A_%a.out
#SBATCH --error=slurm_logs/clay-9ch-array_%A_%a.err
...
WANDB_NAME="clay_9ch_${DATE_TIME}_run${SLURM_ARRAY_TASK_ID}"
...
INPUT_CHANNELS=9
MODEL_TYPE="clay_foundation_model"

echo "======================================================"
echo "Starting Clay Foundation Model 9-Channel Training"
echo "======================================================"
...
# Navigate to Clay experiment directory
...
# Execute the Clay training command
...
echo "======================================================"
echo "Finished Clay 9-channel foundation model training"
echo "======================================================"
