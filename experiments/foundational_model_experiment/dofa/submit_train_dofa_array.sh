...
#-----------------------------------------------------------------------------
# Slurm job array for DOFA foundation model training with 9-channel input.
# Adapts pre-trained DOFA weights to 9-channel multi-modal data.
#-----------------------------------------------------------------------------

# Set the name of the job
#SBATCH --job-name=dofa-9ch-array
...
# Set the memory for each job (optimized for 9-channel DOFA + foundation model)
#SBATCH --mem=128G
...
#SBATCH --output=slurm_logs/dofa-9ch-array_%A_%a.out
#SBATCH --error=slurm_logs/dofa-9ch-array_%A_%a.err
...
WANDB_NAME="dofa_9ch_${DATE_TIME}_run${SLURM_ARRAY_TASK_ID}"
...
INPUT_CHANNELS=9
MODEL_TYPE="dofa_foundation_model"

echo "======================================================"
echo "Starting DOFA Foundation Model 9-Channel Training"
echo "======================================================"
...
# Navigate to DOFA experiment directory
cd /u/nathanj/national_ml/experiments/foundational_model_experiment/dofa

# Set WandB environment variable for unique run naming
export WANDB_RUN_ID="${WANDB_NAME}"
export WANDB_NAME="${WANDB_NAME}"

# Execute the DOFA training command
python training/train_dofa.py \
    --config configs/dofa_config.yaml \
    --gpus 1
...
echo "======================================================"
echo "Finished DOFA 9-channel foundation model training"
echo "======================================================"
