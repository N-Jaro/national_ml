...
#SBATCH --job-name=prithvi_full_eval

# Specify the output and error files for each job
#SBATCH --output=slurm_logs/prithvi_full_eval_%j.out
#SBATCH --error=slurm_logs/prithvi_full_eval_%j.err

# Prithvi Foundation Model Full Evaluation - All 67 Test HUCs

echo "Starting Prithvi Foundation Model Full Evaluation (67 HUCs) at $(date)"
...
# Run batch evaluation for Prithvi only
echo "Starting Prithvi evaluation on 67 HUCs..."
...
echo "Prithvi full evaluation completed at $(date)"