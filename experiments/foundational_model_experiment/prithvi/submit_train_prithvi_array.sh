...
#-----------------------------------------------------------------------------
# Slurm job array for Prithvi foundation model training with 9-channel input.
# Adapts pre-trained 6-channel Prithvi weights to 9-channel multi-modal data.
#-----------------------------------------------------------------------------

# Set the name of the job
#SBATCH --job-name=prithvi-9ch-array
...
# Set the memory for each job (optimized for 9-channel Prithvi + foundation model)
#SBATCH --mem=128G

# Set the maximum time each job will run (foundation models need more time)
#SBATCH --time=72:00:00

# Job array with 10 runs, but only 3 concurrent at a time (foundation models are memory intensive)
#SBATCH --array=1-1%1

# Specify the output and error files for each job
#SBATCH --output=slurm_logs/prithvi-9ch-array_%A_%a.out
#SBATCH --error=slurm_logs/prithvi-9ch-array_%A_%a.err
...
WANDB_NAME="prithvi_9ch_${DATE_TIME}_run${SLURM_ARRAY_TASK_ID}"
...
echo "======================================================"
echo "Starting Prithvi Foundation Model 9-Channel Training"
echo "======================================================"
...
# Navigate to Prithvi experiment directory
...
# Execute the Prithvi training command
...
echo "======================================================"
echo "Finished Prithvi 9-channel foundation model training"
echo "======================================================"
